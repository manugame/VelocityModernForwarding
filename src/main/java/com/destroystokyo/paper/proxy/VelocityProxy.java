...
import be.manugame.velocitymodernforwarding.VelocityModernForwarding;
...
public class VelocityProxy {
    ...
    public static boolean checkIntegrity(final FriendlyByteBuf buf) {
        ...
        try {
            ...
            mac.init(new SecretKeySpec(VelocityModernForwardingConfig.getSecretToken().getBytes(java.nio.charset.StandardCharsets.UTF_8), "HmacSHA256"));
